...
<!-- last sync: 2026-05-16 17:20 · sources: d3-data.json + claude-md-template.md + this repo's README/docs · projects: sophicon-sdk, sophicon-g2 -->

# soPHICON SDK

**Status:** Active Dev  ·  **Version:** v1.0  ·  **Ecosystem:** sophicon
**Folder:** `~/Desktop/soPHICON ER-G2/`
